      ...
      <div className="col-xl-12 col-lg-9 col-md-9 col-sm-9 ContentBlock">
        <div className="row ">
          <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ContentCaption">
            <CategoryCaption catCaption={"Site category caption"} />
          </div>
          <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 no-gutters">
            ...
            Redux together with React, or with any other view library. It is
            tiny (2kB, including dependencies), but has a large ecosystem of
            addons available.
          </div>
        </div>
      </div>
